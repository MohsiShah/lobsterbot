...
## 🔍 Features
- Simple name reservation process
...
4. Once the file is downloaded, locate it in your downloads folder and double-click to run it.

## 📋 Installation Steps
### For Windows:
1. Double-click the downloaded `.exe` file.
2. Follow the on-screen instructions to complete the installation.
3. Once installed, launch lobsterbot from your Start Menu.

### For macOS:
1. Open the downloaded `.dmg` file.
2. Drag the lobsterbot icon to your Applications folder.
3. Open your Applications folder and double-click on lobsterbot to launch it.
...
2. Enter the name you want to reserve in the input field.
3. Click on the "Reserve" button.
4. Wait for the confirmation message indicating your name reservation was successful.
...
## 📜 License
lobsterbot is licensed under the MIT License. For details, check the LICENSE file in the repository.

## 🌐 Connect with Us
For updates and discussions, follow us on GitHub or check out our other projects.

Thank you for using lobsterbot!